...
WSH.age1 <- lencat(~TL, data = WSH.age, startcat = 220, w=10) #categorized fish by size bin
#startcat=170 because my min length was 222
...
plot(TL~jitter(Age), data=WSH.comb, ylab="Total Length (mm)", 
     xlab="Age (Otolith) (jittered)", main="Saugey (WSH)") 
